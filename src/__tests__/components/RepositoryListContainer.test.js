import { RepositoryListContainerOld } from "../../components/RepositoryList";
...
describe('RepositoryList', () => {
  describe('RepositoryListContainer', () => {
    it('renders repository information correctly', () => {
      ...
      render(<RepositoryListContainerOld repositories={repositories} />)
      ...
      expect(firstRepositoryItem).toHaveTextContent((1619/1000).toFixed(1));
      expect(firstRepositoryItem).toHaveTextContent((21856/1000).toFixed(1));
      ...
      expect(secondRepositoryItem).toHaveTextContent((1760/1000).toFixed(1));
